import os
import webbrowser
webbrowser.open('https://t.me/abdtools')
os.system('clear')
try:
    ...
    sleep(0.1)
    os.system('clear')
    start_msg = requests.post(f"https://api.telegram.org/bot{tok}/sendMessage?chat_id={ID}&text=اشترك لتفعيل الادة بشكل كامل @Abdtools").json()
